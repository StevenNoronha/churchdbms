...
$result = "";
    ...
    if($flag == true) {
    $sql1 = "SELECT * FROM `epiz_33875867_church`.`committee` WHERE Church_ID = ('$churchid')";
...
<head>
    ...
    <title>View Committee Details</title>
</head>
<body>
...
<div class="container">
<form class="container formcs" action="commitd.php" method="post">
  <h2>Enter Church ID</h2>
   ...
   if($insert1 == true){
    ?>
  <h2 class="formcs"><u>Commitee details</u></h2>
  <div class="tabledis">
    <table >
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            <td><?php echo $rows1['Committee_ID'];?></td>
            <td><?php echo $rows1['Committee_Name'];?></td>
            <td><?php echo $rows1['Chairman'];?></td>
            <td><?php echo $rows1['Number_of_members'];?></td>
            <td><?php echo $rows1['Objective'];?></td>
          </tr>
          <?php
          }
