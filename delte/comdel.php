...
$flag = false;
    ...
    function test_input($data) {
      ...
      if($flag == true) {
            $sql = "DELETE FROM `epiz_33875867_church`.`committee` WHERE `Committee_ID` = '$comid' ";
...
?>
<div class="container">
<form class="container formcs" action="comdel.php" method="post">
  <h2>Enter Committee ID that needs to Deleted</h2>
...
<label>
    <h3>
      <?php 
      if($insert == true)
      { echo "Succesfully deleted the record with ID <br>". $comid;
      }
      ?>
    </h3>
</label>
